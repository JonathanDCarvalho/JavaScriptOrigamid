...
// Native:
// Objetos nativas são aqueles definidos na especificação da linguagem e são implementados independente do host
...
if (typeof Array.from) console.log("Existe");
else console.log("Não Existe");

if (typeof NodeList) console.log("Existe");
else console.log("Não Existe");
